...
import { Row, Col, Table } from 'reactstrap'; // Anda perlu import <Table>
...
class Library extends React.Component{
 ...
 <DatatableWrapper
  ...
  labels={customLabels}
>
  {/* Ini adalah bagian untuk filter dan tombol pagination */}
  <Row className="mb-4">
    <Col
      xs={12}
      lg={4}
  ...
  {/* Ini adalah tabelnya */}
  <Table className="striped table-hover table-responsive">
    <TableHeader />
    <TableBody />
  </Table>
