...
moment.locale('en-GB');
const localizer = momentLocalizer(moment); // Simpan localizer di variabel

class UniversityEvents extends React.Component {
  render() {
 
	const allViews = Object
  .keys(Calendar.Views) // Ganti BigCalendar menjadi Calendar
                                ...
                                <div className="row">
                                    <div className="col-lg-12">
									  ...
									  <div style={{ height: 700, width: 100+'%' }}>
									    <Calendar
    localizer={localizer} // TAMBAHKAN prop ini
    events={events}
    step={60}
    views={allViews}
