...
import { PolarArea, Line, Pie } from 'react-chartjs-2';
...
import {
    ...
    PointElement,
    LineElement,
    RadialLinearScale, // Untuk PolarArea
    ArcElement,        // Untuk PolarArea dan Pie
    Tooltip,
    Legend,
} from 'chart.js';
                        ...
                        <section className="box ">
                            ...
                            <div className="content-body">
                                <div className="row">
                                    ...
                                    <div className="chart-area" style={{height: 500+'px'}}>
                                        <PolarArea data={data2} options={gradientChartOptionsConfiguration3} />
                                    </div>
